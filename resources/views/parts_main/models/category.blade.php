...
<div class='container main-container leftheader'>
    <div class="row">
        <div class="d-block col-12 col-md-12 col-lg-7 col-xl-6">
            <div class="row">
                <div class="d-block  col-12 col-sm-12 col-md-6 col-lg-12">
                    <div class="thin-line"></div>
                    <h1>{{rt("!brand!") }} {{$model->name}} {{$category->type}} REPLACEMENT</h1>
                ...
                <div class="col-12 col-md-6  col-lg-12 " >
                    ...
                    <div class="row">
                        <div class="col-4 ">
                            <div class="category_image">    <img src="{{$model->ImageThumb}}"></div>
                        </div>
                        <div class="col-8">
                ...
                <div class="d-block d-sm-block d-md-none d-lg-block col-4 ">
                    <div class="thin-line "></div>
                    @if($banner = get_promo_banner())
                    <div class="discount-block">          
                        <span>{{$banner['percent']}}%</span><br>
                ...
                <div class="col-8 col-md-6 col-lg-8 "  >
                    ...
                    <div class="thin-line-2  "></div>
                    <div class="inside-block-margin">{!! text_block('BRAND_SHORT_TEXT') !!}</div>
        ...
        <div class="d-block d-md-none d-lg-block col-12 col-md-6 col-lg-5 col-xl-6">
